...
class KMeansEnglishNews:
    ...
    def load_data(self):
        #  遍历简单文本所有文件
        ori_dir_path = self.global_set.text_e_dir_name
        ...
        for item in self.class_file_seq_list:
            ...
            for file_index in file_seq:
                ...
                for ii in range(len(cluster_centers)):
                    file_center_dis += file_vector[ii] * cluster_centers[ii]
                temp_file_file_center_score_list.append((file_index, file_center_dis))
            # 排序结果
    ...
    def k_means_cal(self):
        #  开始功能
        print('K_Means English News Function Start.')
        string = '对英文文档进行 K-Means 聚类'
        self.global_set.print_gui(string)
        # 计时
